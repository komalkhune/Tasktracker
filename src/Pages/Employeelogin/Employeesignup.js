...
const Employeesignup=()=>{
    ...
    const signup=()=>{
        ...
        dispatcher(actions.stusiginfo(stusiginfo))

       const stufound = stuinfo.find((item)=>{return(item.email===username)})
        ...
        <>
         ...
         <div className={mystyle.logincontainer}>
            <div className={mystyle.loginbox}>
                ...
                <h2 className={mystyle.title}>Student Signup</h2>
              ...
              {errorvalid && (
                ...
                <p className={mystyle.navigatebtn}>Already have an account? <Link to="/employeelogin">Login</Link> </p>
